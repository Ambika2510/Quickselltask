...
const Prioritycard = ({id,title,tag,status}) => {
  ...
  {status === "In progress"?<TbProgressBolt style={{marginRight:"1px",marginLeft:"4px",color:"orange"}}/>:(status === "Todo"?<BsCircle style={{marginRight:"1px",marginLeft:"4px",color:"grey"}}/>:status === "Backlog"?<MdOutlineSmsFailed style={{marginRight:"1px",marginLeft:"4px",color:"blue"}}/>:status === "Done"?<AiOutlineCheckCircle style={{marginRight:"1px",marginLeft:"4px",color:"green"}} />:status === "Cancelled"?<MdOutlineCancel style={{marginRight:"1px",marginLeft:"4px",color:"red"}}/>:"")}
     <h3 style={{marginTop:"4px",marginLeft:"2px",marginRight:"2px", fontSize:"15px",fontWeight:"800"}}>{title}</h3>
    </div>
    <div style={{display:"flex",justifyContent:"center", position:"absolute",bottom:"1px",left:"35px"}}>
