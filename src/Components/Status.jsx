    ...
    <div className="status">
      <div style={{ marginLeft: "8px", marginRight: "8px" }}>
        ...
        >
          ...
          >
            <MdOutlineSmsFailed style={{ marginRight: "7px", color: "blue" }} />{" "}
            <h3>Backlogs {backlogs.length}</h3>
          </div>{" "}
          <div
            style={{
              display: "flex",
      ...
      <div className="s2" style={{ marginLeft: "8px", marginRight: "8px" }}>
        ...
        >
          ...
          >
            <BsCircle style={{ marginRight: "7px", color: "grey" }} />
      ...
      <div className="s3" style={{ marginLeft: "8px", marginRight: "8px" }}>
        ...
        >
          ...
          >
            <TbProgressBolt style={{ marginRight: "7px", color: "orange" }} />
      ...
      <div className="s5" style={{ marginLeft: "8px", marginRight: "8px" }}>
        ...
        >
          ...
          >
            <MdOutlineCancel style={{ marginRight: "7px", color: "red" }} />
